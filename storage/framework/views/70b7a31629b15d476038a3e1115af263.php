    ...
    <div class="bg-gradient-to-r from-orange-600 to-orange-700 text-white py-20">
        <div class="container mx-auto px-6">
            <div class="text-center">
                <h1 class="text-5xl font-bold mb-6"><?php echo e(__('messages.business_customer_title')); ?></h1>
                <p class="text-xl mb-8 max-w-3xl mx-auto"><?php echo e(__('messages.business_customer_subtitle')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CourierXpress\resources\views/customers/doanh-nghiep.blade.php ENDPATH**/ ?>