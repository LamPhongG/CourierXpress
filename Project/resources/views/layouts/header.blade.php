    ...
    <div class="container mx-auto px-6">
        ...
        <!-- Logo -->
            ...
            <div class="flex items-center space-x-3 flex-shrink-0">
                ...
                <!-- Login -->
                <a href="{{ route('login') }}" class="flex items-center hover:text-gray-200 px-2 py-1 rounded transition duration-300 text-sm">
                ...
                <!-- Sign Up -->
                <a href="{{ route('register') }}" class="bg-white text-orange-600 font-semibold px-3 py-2 rounded-lg hover:bg-gray-100 transition duration-300 text-sm">
                    {{ __('lalamove.sign_up') }}
                </a>
