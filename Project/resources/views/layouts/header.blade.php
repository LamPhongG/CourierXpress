<header class="fixed top-0 left-0 w-full bg-orange-600 text-white shadow-md z-50">
    <div class="container mx-auto flex justify-between items-center py-3 px-6">
        ...
        <div class="flex items-center space-x-4 bg-orange-500 p-2 rounded-lg">
            <a href="#" class="flex items-center hover:text-gray-200 space-x-2">
                <!-- Icon user trắng -->
                ...
                <span class="text-white font-semibold">Đăng ký/Đăng nhập</span>


                <button
                    class="bg-white text-orange-600 font-semibold px-3 py-1 rounded-md hover:bg-gray-100 flex items-center space-x-2">
                    <!-- Icon tìm kiếm -->
