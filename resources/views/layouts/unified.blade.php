...
<body style="background-color: #FAFAFA;">
    <!-- Unified Header -->
    <header style="background-color: #FAFAFA;" class="shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <!-- Logo -->
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center space-x-3 hover:opacity-80 transition duration-300">
                        <div class="w-10 h-10 bg-primary rounded-lg flex items-center justify-center">
                            <i class="fas fa-shipping-fast text-white"></i>
                        </div>
                        <span class="text-2xl font-bold text-gray-900 cursor-pointer">CourierXpress</span>
                    </a>
                    @if(isset($role_title))
